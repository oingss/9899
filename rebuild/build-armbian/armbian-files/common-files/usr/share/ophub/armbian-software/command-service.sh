...
EOF
        ...
        sudo systemctl disable common-zram-config.service 2>/dev/null || true
        sudo systemctl disable common-ramlog.service 2>/dev/null || true
        sudo systemctl disable armbian-zram-config.service 2>/dev/null || true
        sudo systemctl disable armbian-ramlog.service 2>/dev/null || true
